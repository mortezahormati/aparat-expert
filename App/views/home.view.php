            ...
            <div class="container-fluid ">
                ...
                <div class="row" style="margin-top: 5%">
                    <div class="container-fluid  ">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-2">
                                        <a href="<?= asset('best-videos') ?>" style="text-decoration: none !important;" class="text-center text-danger text-decoration-none" aria-label="left" data-list-more-link="true" data-size="small">
                                            <div class="content">
                        ...
                        <?php endif; ?>
                        <?php if(!is_null($most_revision_videos)): ?>
                        <div class="row">
                            <div class="col-md-12 mb-4">
                                <div class="row mb-3">
                                    <div class="col-md-2 ">
                                    ...
                                    <div class="col-md-8"></div>
                                    <div class="col-md-2">
                                        <a href="<?= asset('most-revision-videos') ?>" style="text-decoration: none !important;" class="text-center text-danger text-decoration-none" aria-label="left" data-list-more-link="true" data-size="small">
                                            <div class="content">
                                                <span class="text" style="font-size: 12px;font-weight: 800"> مشاهده همه </span>
                                                <i class="fa fa-arrow-left"></i>
                                            </div>
