...
if(isset($_SESSION['VideoUpdatedSuccessfully'])){
    echo '<div class="alert alert-success">'.$_SESSION["VideoUpdatedSuccessfully"].'</div>';
    unset($_SESSION['VideoUpdatedSuccessfully']);
}
