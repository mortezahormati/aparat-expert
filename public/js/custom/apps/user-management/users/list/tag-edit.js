...
var KTCategoryEdit = function () {
    // Shared variables
    const element = document.getElementById('kt_modal_edit_tag');
    const form = element.querySelector('#kt_modal_edit_tag_form');
            ...
            if (validator) {
                ...
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        ...
                        var data = $("#kt_modal_edit_tag_form").serialize();
                        ...
                        setTimeout(function () {
                            ...
                            Swal.fire({
                                text: "برچسب مورد نظر با موفقیت به روزرسانی شد .",
                                icon: "success",
