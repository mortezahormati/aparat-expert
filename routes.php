...
$router->get('/administrator/category/edit/ajax' , 'Controller/admin/category/edit/ajax.request.php');

$router->post('/administrator/category/ajax' , 'Controller/admin/category/ajax.request.php');
$router->post('/administrator/category/edit/ajax' , 'Controller/admin/category/edit/ajax.request.php');
